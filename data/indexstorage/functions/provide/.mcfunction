...
# 未使用idチェック
    ...
    execute if data storage indexstorage:core UnusedID[-1] run function indexstorage:array/session/open
    execute if data storage indexstorage:core UnusedID[-1] run data modify storage indexstorage:core Array set from storage indexstorage:core UnusedID
    execute if data storage indexstorage:core UnusedID[-1] run function indexstorage:array/sort/ascend
    ...
    execute if data storage indexstorage:core UnusedID[-1] run function indexstorage:array/session/close
